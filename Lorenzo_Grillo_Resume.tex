    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \begin{highlights}
                ...
                \item A full implementation of 3 components of an SSI system - business logic for the credential holder's wallet, the issuer's issuance system, and the verifier's presentation handler, all in Python; and an example credential wallet frontend in ReactJS
